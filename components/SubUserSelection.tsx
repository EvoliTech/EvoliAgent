...
export const SubUserSelection: React.FC<SubUserSelectionProps> = ({ empresaId, onLoginSuccess, onLogout, onFirstAccess, onRequireSetupModal }) => {
  ...
  useEffect(() => {
    const loadSubUsers = async () => {
      try {
        ...
        if (isFirst && onFirstAccess) {
          if (!skippedLocally) {
            onFirstAccess();
          } else if (onRequireSetupModal) {
            onRequireSetupModal();
          }
          return;
        }
